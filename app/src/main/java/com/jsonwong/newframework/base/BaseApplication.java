...
public class BaseApplication extends Application {
    ...
    private static ArrayList<ChannelItem> channleItemList = null;
    static Resources _resource;
    private static String lastToast = "";
    private static long lastToastTime;
    protected RefWatcher _refWatcher;
     ...
     * 取得资讯频道的可用频道
     */
    public static ArrayList<ChannelItem> getChannleItemList(Context context) {
       // if (channleItemList == null) {
            channleItemList = (ArrayList<ChannelItem>) ChannelManageService.getInstance(context).getUserChannel();
        //}
        return channleItemList;
    }
