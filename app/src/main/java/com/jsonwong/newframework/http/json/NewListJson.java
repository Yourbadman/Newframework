...
package com.jsonwong.newframework.http.json;

import android.content.Context;

import com.jsonwong.newframework.bean.ImagesModle;
...
public class NewListJson extends JsonPacket {
    ...
    public List<NewModle> readJsonNewModles(String res, String value) {
        ...
        try {
            ...
            for (int i = 1; i < jsonArray.length(); i++) {
                ...
                newModle = readNewModle(newModle, js);
                newModles.add(newModle);
            }
        } catch (Exception e) {
     ...
     * @throws Exception
     */
    public NewModle readNewModle(NewModle newModle, JSONObject jsonObject) throws Exception {
        String docid = "";
        String title = "";
        String digest = "";
        String imgsrc = "";
        ...
        String replyCount = "";
        String url = "";
        replyCount = getString("replyCount", jsonObject);
        ...
        if (newModle == null) newModle = new NewModle();
        ...
        newModle.setTag(tag);
        newModle.setReplyCount(replyCount);
        newModle.setUrl(url);
        return newModle;
    }
