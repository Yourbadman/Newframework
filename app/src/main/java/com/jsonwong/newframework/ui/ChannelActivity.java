...
public class ChannelActivity extends BaseActivity implements OnItemClickListener {
    ...
    public void initView() {
        setActionBarTitle(R.string.actionbar_title_addchannel);
    }

    @Override
    public void initData() {
        userChannelList = ChannelManageService.getInstance(this).getUserChannel();
        otherChannelList = ChannelManageService.getInstance(this).getOtherChannel();
